extensions [ gis ]
patches-own [potentialL potentialR new-potentialL new-potentialR seedp capacity ccapacity elevation elevationT visit]
turtles-own [ xtur ytur xct yct]
globals [cIndex cIndext fileName j filePlots fileView i x1 y1 yt xt xm ym flag countries-dataset elevationL rivers1 rivers2 lakes] 
...
to setup
 clear-all
  ...
  set rivers1 gis:load-dataset "ukcities/rivers1uk.shp"
  set rivers2 gis:load-dataset "ukcities/rivers2uk.shp"
  set lakes gis:load-dataset "ukcities/lakesUK.shp"
  set elevationL gis:load-dataset "ukcities/elevationc.asc"
  ; Set the world envelope to the union of all of our dataset's envelopes
  gis:set-world-envelope (gis:envelope-union-of (gis:envelope-of countries-dataset) (gis:envelope-of elevationL) (gis:envelope-of rivers1)(gis:envelope-of rivers2)(gis:envelope-of lakes))
 

;layout sea. We initialize everything at a high potential
ask patches [set pcolor 97 
  set potentialL 0.5
  set potentialR 0.5
  ]
 
  ;gis:paint elevationL 0
  ...
  gis:draw rivers2 2
  gis:fill lakes 1
  gis:apply-raster elevationL elevation  
...
ask patches gis:intersecting countries-dataset
  [ set pcolor 67
    ;;set Local potentials
    set potentialL one-of [1 -1]
    ; set potentialR one-of [-1 1 2]
        
    ;set capacity 5 
    set ccapacity 0
    
    ;;set Regional potentials
    set potentialR 0
    
    set visit 0
   ] 

 ask patches gis:intersecting lakes[
   ;set pcolor 95
   set potentialL 0
   set potentialR 0
   ] 
 ask patches gis:intersecting rivers1[
   ;set pcolor 95
   set potentialL 0
   set potentialR 0
   ]  
  ask patches gis:intersecting rivers2[
   ;set pcolor 95
   set potentialL 0
   set potentialR 0
   ] 
...
to fillrivers
  ask patches [
    if ( (pxcor >= 333 and pycor >= 92) and (pxcor <= 345 and pycor <= 93) )  
     or ( (pxcor >= 329 and pycor >= 90) and (pxcor <= 332 and pycor <= 92) )
     or ( (pxcor >= 280 and pycor >= 191) and (pxcor <= 300 and pycor <= 191) )
     or ( (pxcor >= 280 and pycor >= 190) and (pxcor <= 281 and pycor <= 190) )
     or ( (pxcor >= 202 and pycor >= 103) and (pxcor <= 205 and pycor <= 104) )
            [set pcolor 97 set potentialL 0.5  set potentialR 0.5]
    ]
  
  ask patches [
    if ( (pxcor >= 304 and pycor >= 185) and (pxcor <= 309 and pycor <= 187) )
    or ( (pxcor >= 180 and pycor >= 172) and (pxcor <= 190 and pycor <= 174) )
    or ( (pxcor >= 166 and pycor >= 212) and (pxcor <= 169 and pycor <= 215) )
    or ( (pxcor >= 164 and pycor >= 246) and (pxcor <= 177 and pycor <= 247) )
    or ( (pxcor >= 94 and pycor >= 290) and (pxcor <= 111 and pycor <= 291) )
    or ( (pxcor >= 93 and pycor >= 296) and (pxcor <= 94 and pycor <= 300) )
    or ( (pxcor >= 145 and pycor >= 294) and (pxcor <= 159 and pycor <= 294) )
    or ( (pxcor >= 169 and pycor >= 309) and (pxcor <= 177 and pycor <= 313) )
    or ( (pxcor >= 163 and pycor >= 308) and (pxcor <= 168 and pycor <= 310) )
    or ( (pxcor >= 178 and pycor >= 311) and (pxcor <= 184 and pycor <= 313) )
    or ( (pxcor >= 116 and pycor >= 375) and (pxcor <= 134 and pycor <= 376) )
    or ( (pxcor >= 53 and pycor >= 337) and (pxcor <= 64 and pycor <= 338) )
    or ( (pxcor >= 55 and pycor >= 342) and (pxcor <= 71 and pycor <= 343) )
    or ( (pxcor >= 53 and pycor >= 349) and (pxcor <= 70 and pycor <= 349) )
    or ( (pxcor >= 57 and pycor >= 344) and (pxcor <= 61 and pycor <= 349) )
    or ( (pxcor >= 56 and pycor >= 352) and (pxcor <= 69 and pycor <= 356) )
    or ( (pxcor >= 56 and pycor >= 361) and (pxcor <= 66 and pycor <= 362) )
    or ( (pxcor >= 50 and pycor >= 315) and (pxcor <= 60 and pycor <= 316) )
    or ( (pxcor >= 35 and pycor >= 321) and (pxcor <= 39 and pycor <= 323) )
    or ( (pxcor >= 43 and pycor >= 319) and (pxcor <= 44 and pycor <= 320) )
    or ( (pxcor >= 54 and pycor >= 299) and (pxcor <= 58 and pycor <= 300) )
    or ( (pxcor >= 67 and pycor >= 312) and (pxcor <= 82 and pycor <= 314) )
    or ( (pxcor >= 69 and pycor >= 316) and (pxcor <= 78 and pycor <= 317) )
    or ( (pxcor >= 85 and pycor >= 245) and (pxcor <= 87 and pycor <= 250) )
    or ( (pxcor >= 74 and pycor >= 322) and (pxcor <= 89 and pycor <= 324) )
    or ( (pxcor >= 114 and pycor >= 363) and (pxcor <= 120 and pycor <= 365) )
    or ( (pxcor >= 119 and pycor >= 366) and (pxcor <= 127 and pycor <= 368) )
    or ( (pxcor >= 122 and pycor >= 359) and (pxcor <= 130 and pycor <= 364) )
    or ( (pxcor >= 43 and pycor >= 322) and (pxcor <= 64 and pycor <= 324) )
    or ( (pxcor >= 250 and pycor >= 58) and (pxcor <= 260 and pycor <= 60) )
    or ( (pxcor >= 242 and pycor >= 56) and (pxcor <= 250 and pycor <= 59) )
    or ( (pxcor >= 342 and pycor >= 87) and (pxcor <= 345 and pycor <= 90) )
    or ( (pxcor >= 176 and pycor >= 174) and (pxcor <= 179 and pycor <= 180) )
    or ( (pxcor >= 121 and pycor >= 98) and (pxcor <= 130 and pycor <= 100) )
    or ( (pxcor >= 202 and pycor >= 103) and (pxcor <= 205 and pycor <= 104) )
    or ( (pxcor >= 81 and pycor >= 299) and (pxcor <= 83 and pycor <= 300) )
    or ( (pxcor >= 87 and pycor >= 100) and (pxcor <= 95 and pycor <= 102) )  
    or ( (pxcor >= 93 and pycor >= 102) and (pxcor <= 96 and pycor <= 105) )  
    or ( (pxcor >= 79 and pycor >= 285) and (pxcor <= 81 and pycor <= 290) )    
        [set potentialL 0.5  set potentialR 0.5]
    let xtemp 196 let ytemp 98    
    while [xtemp <= 203 and ytemp <= 102] [
       set xtemp xtemp + 1  set ytemp ytemp + 1
              ask patch xtemp ytemp  [set pcolor 97 set potentialL 0.5  set potentialR 0.5]
    ]
    set xtemp 73 set ytemp 292    
    while [xtemp <= 79 and ytemp <= 299] [
       set xtemp xtemp + 1  set ytemp ytemp + 1
              ask patch xtemp ytemp  [set pcolor 97 set potentialL 0.5  set potentialR 0.5]              
    ]
    set xtemp 82 set ytemp 298    
    while [xtemp <= 92 and ytemp <= 304] [
       set xtemp xtemp + 1  set ytemp ytemp + 1
              ask patch xtemp ytemp  [set pcolor 97 set potentialL 0.5  set potentialR 0.5]              
    ]
    set xtemp 77 set ytemp 323    
    while [xtemp <= 83 and ytemp <= 329] [
       set xtemp xtemp + 1  set ytemp ytemp + 1
              ask patch xtemp ytemp  [set pcolor 97 set potentialL 0.5 set potentialR 0.5]              
    ]    
]  
...
to fillelevations
  ask patches [
    if ( (pxcor >= 57 and pycor >= 20) and (pxcor <= 70 and pycor <= 65) ) 
       [set elevation -1.516052319]
    if ( (pxcor >= 86 and pycor >= 20) and (pxcor <= 129 and pycor <= 65) ) 
       [set elevation 0.881093936]
    if ( (pxcor >= 130 and pycor >= 20) and (pxcor <= 180 and pycor <= 65) ) 
       [set elevation 0.766944114]
    if ( (pxcor >= 181 and pycor >= 20) and (pxcor <= 221 and pycor <= 65) ) 
       [set elevation -0.023120624]
    if ( (pxcor >= 222 and pycor >= 20) and (pxcor <= 269 and pycor <= 65) ) 
       [set elevation -0.428986656]
    if ( (pxcor >= 270 and pycor >= 20) and (pxcor <= 312 and pycor <= 65) ) 
       [set elevation -0.569692165]
     if ( (pxcor >= 313 and pycor >= 20) and (pxcor <= 382 and pycor <= 65) ) 
       [set elevation -0.808561237]                                  
 ]
end

;;cities foundation
to setHA
  historicalAccidents 30 100 1 x1 y1 black
end
to historicalAccidents [p c cc x y pc]
 ...
 ;; ask patches gis:intersecting countries-dataset [ 
 ;;   if potentialR = 1 [set pcolor red]
 ;;   if potentialR = -1 [set pcolor blue]
 ;;   ]
end

;;initial capacities
to setC
  Capacities x1 y1 100 0 0
  ;;set Regional Potential
  ask patches gis:intersecting countries-dataset
  [ 
    ask patch pxcor pycor [if potentialR = 0 [ let pt one-of [-1 1] set potentialR pt ask neighbors [set potentialR pt]]]
      ;;set elvationT
   
  ; carefully [ set elevationT  exp ((elevation + sum [elevation] of neighbors) / 5)] [set elevationT 5]
  carefully [ set elevationT elevation + sum [elevation] of neighbors / 9] [set elevationT 2]
...
to go
  ...
  ask patches gis:intersecting countries-dataset [ 
 ;   let stemp count neighbors4 with [potentialL < -30]
  ;  let s sum [potentialL] of neighbors4  + stemp * 1000
   ; set new-potential (potential + sum [potential] of neighbors4 ) / 5 + one-of [1 -1] + (0.0001 * (ccapacity + sum [ccapacity] of neighbors4 / 5 ))]
   
   ;;Local potencial
   ;; Lets assume that my own potential is affected by my own ccapacity. potentialL(ccapacity) at some point after taking into account the nn
   
   
   set new-potentialL (potentialL + sum [potentialL] of neighbors4) / 5 + ((potentialR / 9) * 0.01)  + (ccapacity * 0.001) + one-of [1 -1] 

   
   ;;Regional potential
   ifelse elevationT <= 0.1
    [set new-potentialR potentialR + ((potentialL + sum [potentialL] of neighbors) * 0.01) + one-of [-1 1]]
    [set new-potentialR potentialR + ((potentialL + sum [potentialL] of neighbors) * 0.01) - elevationT + one-of [-1 1]]
 
      
   setRPotentials pxcor pycor new-potentialR
 
   set potentialL new-potentialL
   set potentialR new-potentialR
   fixPotential x1 y1 5  
   if potentialL > thresholdL [ ;set pcolor 9.9        
     set pcolor scale-color gray ccapacity 1 50
     set ccapacity ccapacity + 1
     if ccapacity > capacity 
        [avalanche]
   ]
   if potentialR > thresholdR [ set pcolor 9.9 ]
   set visit 0           
  ]
  
  my-update-plots
  tick  ;; why im ticking before
...
to setRPotentials [x y pr]
      ask patch x y [if visit = 0 [ ask neighbors [set potentialR pr]] set visit 1]
end
...
to getInradius [x y rad c]
 if (distancexy x y) < rad
   ...
   let r max-one-of patches in-radius 15 [potentialL]
...
to createP [n]
  ...
  create-turtles n
    [ 
      ...
      ;let trlid who
      ask patch-at xtur ytur [if potentialL <= -100.00 [set flag 1]]
...
to saveFile
    ...
    if ticks > 500 [  
              ...
              ask patches [set pcolor 95
                set potentialL -1000  set potentialR -1000]
               ask patches gis:intersecting countries-dataset
             [ set pcolor 67
            set potentialL one-of [1 -1]  set potentialR elevation
            set capacity 5 
          set ccapacity 0
           ]               
             setHA
...
to my-update-plots
  ...
  plot count patches with [potentialL > thresholdL]
end
@#$#@#$#@
GRAPHICS-WINDOW
224
